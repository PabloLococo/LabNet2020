    ...
    public class DaoCustomers : BaseDao, IAltaBajaMedia<Customers,string>
    {
        ...
        public Customers GetbyId(string id)
        {
            ...
            catch (SqlException ex)
            {
                ...
                var mensaje = "Hubo un error en base de datos, Por favor verifique que el ID ingresado sea valido o llame a mantenimiento si el problema persiste";
                throw new CustomExeptionSql(mensaje);
            }
            catch (Exception ex)
            {
        ...
        public Customers Insert(Customers entity)
        {
            ...
            catch(SqlException ex)
            {
                ...
                var mensaje =  "Hubo un error en base de datos, Por favor vuelva a intentarlo o llame a mantenimiento si el problema persiste";
                throw new CustomExeptionSql(mensaje);
            }
            catch (Exception ex)
            {
        ...
        public void Update(Customers entity)
        {
            ...
            {
                log.Info("La llamada a Sql tuvo un error en Sql" + ex.Message);
                var mensaje = "Hubo un error en base de datos, Por favor comprueve que los datos sean validos o llame a mantenimiento si el problema persiste";
                throw new CustomExeptionSql(mensaje);
            }
            catch (Exception ex)
            {
        ...
        public void Delete(Customers entity)
        {
            ...
            {
                log.Info("La llamada a Sql tuvo un error en Sql" + ex.Message);
                var mensaje = "Hubo un error en base de datos, Por favor comprueve que los datos existan o llame a mantenimiento si el problema persiste";
                throw new CustomExeptionSql(mensaje);
            }
            catch (Exception ex)
            {
